...
function read_ansi_encoded_string(cursor: Buffer, position: number, size: number, ansi_codec: string): string | null {
    if (position + size > cursor.length) return null;
    const stringBuffer = cursor.subarray(position, position + size);
...
export function value_type_from_u8(byte: number): BinXmlValueType | null {
    switch (byte) {
        case 0x00: return BinXmlValueType.NullType;
        case 0x01: return BinXmlValueType.StringType;
        case 0x02: return BinXmlValueType.AnsiStringType;
        case 0x03: return BinXmlValueType.Int8Type;
        case 0x04: return BinXmlValueType.UInt8Type;
        case 0x05: return BinXmlValueType.Int16Type;
        case 0x06: return BinXmlValueType.UInt16Type;
        case 0x07: return BinXmlValueType.Int32Type;
        case 0x08: return BinXmlValueType.UInt32Type;
        case 0x09: return BinXmlValueType.Int64Type;
        case 0x0a: return BinXmlValueType.UInt64Type;
        case 0x0b: return BinXmlValueType.Real32Type;
        case 0x0c: return BinXmlValueType.Real64Type;
        case 0x0d: return BinXmlValueType.BoolType;
        case 0x0e: return BinXmlValueType.BinaryType;
        case 0x0f: return BinXmlValueType.GuidType;
        case 0x10: return BinXmlValueType.SizeTType;
        case 0x11: return BinXmlValueType.FileTimeType;
        case 0x12: return BinXmlValueType.SysTimeType;
        case 0x13: return BinXmlValueType.SidType;
        case 0x14: return BinXmlValueType.HexInt32Type;
        case 0x15: return BinXmlValueType.HexInt64Type;
        case 0x20: return BinXmlValueType.EvtHandle;
        case 0x21: return BinXmlValueType.BinXmlType;
        case 0x23: return BinXmlValueType.EvtXml;
        case 0x81: return BinXmlValueType.StringArrayType;
        case 0x82: return BinXmlValueType.AnsiStringArrayType;
        case 0x83: return BinXmlValueType.Int8ArrayType;
        case 0x84: return BinXmlValueType.UInt8ArrayType;
        case 0x85: return BinXmlValueType.Int16ArrayType;
        case 0x86: return BinXmlValueType.UInt16ArrayType;
        case 0x87: return BinXmlValueType.Int32ArrayType;
        case 0x88: return BinXmlValueType.UInt32ArrayType;
        case 0x89: return BinXmlValueType.Int64ArrayType;
        case 0x8a: return BinXmlValueType.UInt64ArrayType;
        case 0x8b: return BinXmlValueType.Real32ArrayType;
        case 0x8c: return BinXmlValueType.Real64ArrayType;
        case 0x8d: return BinXmlValueType.BoolArrayType;
        case 0x8e: return BinXmlValueType.BinaryArrayType;
        case 0x8f: return BinXmlValueType.GuidArrayType;
        case 0x90: return BinXmlValueType.SizeTArrayType;
        case 0x91: return BinXmlValueType.FileTimeArrayType;
        case 0x92: return BinXmlValueType.SysTimeArrayType;
        case 0x93: return BinXmlValueType.SidArrayType;
        case 0x94: return BinXmlValueType.HexInt32ArrayType;
        case 0x95: return BinXmlValueType.HexInt64ArrayType;
        default: return null;
    }
}
...
export function from_binxml_stream(
    ...
    try {
        ...
        return { 
            result: err(new Error(`Failed to read from binxml stream: ${e instanceof Error ? e.message : String(e)}`)),
            new_position: offset 
        };
    }
}
...
// console.log(`Offset 0x${offset.toString(16).padStart(8, '0')} (${offset}): ${JSON.stringify(value_type)}, size: ${size}`);
    ...
    try {
        ...
        switch (value_type) {
            ...
            case BinXmlValueType.AnsiStringType:
                if (size !== null) {
                    ...
                    return { 
                        result: err(new Error(`Unimplemented value variant: AnsiString without size at offset ${offset}`)),
                        new_position: pos 
                    };
                }
                break;
            ...
            case BinXmlValueType.SizeTType:
                if (size === 4) {
                    ...
                    return { 
                        result: err(new Error(`Unimplemented value variant: SizeT with size ${size} at offset ${offset}`)),
                        new_position: pos 
                    };
                }
                break;
            ...
            default:
                return { 
                    result: err(new Error(`Unimplemented value variant: ${JSON.stringify(value_type)} at offset ${offset}`)),
                    new_position: pos 
                };
        }
        ...
        return { 
            result: err(new Error(`Failed to deserialize value type: ${e instanceof Error ? e.message : String(e)}`)),
            new_position: pos 
        };
    }
}